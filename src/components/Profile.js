            ...
            <div style={styles.profileSection}>
                ...
                <div style={styles.infoCard}>
                    ...
                    <div style={styles.profileDetailsRow}>
                        ...
                        <pre style={styles.profileValue}>{JSON.stringify(user.accessibility_preferences || {}, null, 2)}</pre>
                    </div>
                    <div style={styles.profileDetailsRow}>
                        <p style={styles.profileLabel}><strong>High Contrast Mode:</strong></p>
                        <p style={styles.profileValue}>{user.high_contrast ? '✔️' : '✖️'}</p>
                    </div>
                    <div style={styles.profileDetailsRow}>
                        <p style={styles.profileLabel}><strong>Screen Reader:</strong></p>
                        <p style={styles.profileValue}>{user.screen_reader ? '✔️' : '✖️'}</p>
                    </div>
                    <div style={styles.profileDetailsRow}>
                        <p style={styles.profileLabel}><strong>Keyboard Navigation:</strong></p>
                        <p style={styles.profileValue}>{user.keyboard_navigation ? '✔️' : '✖️'}</p>
                    </div>
                    <div style={styles.profileDetailsRow}>
                        ...
                        {sharedLocations.map((location) => {
                            ...
                            return (
                                <div key={location.venue.venue_id} style={styles.locationCard}>
                                    ...
                                    <p><strong>Shared By:</strong> {sharedBy ? sharedBy.name : location.shared_by}</p>
